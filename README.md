...
This script have not tested yet
...
# Configure
henu_account="your_account"       # Change this to your account
henu_password="your_password"     # Change this to your password
henu_isp="henulocal"              # Change this to your isp: henudx henult henuyd henulocal
delay="10s"                       # Change this to ping check delay time
enable_logging=true               # Log enable switch  

# Set secure umask for logs
umask 077

# Get IP address, change wlan0 to your ethrtnet interface
